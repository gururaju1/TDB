class CreateTdbankNotifications < ActiveRecord::Migration
  
    
  def self.up
    create_table :tdbank_notifications do |t|
    ...
    add_index :tdbank_notifications, [:psp_reference, :event_code, :success], :unique => true, :name => 'tdbank_notification_uniqueness'
  end

  def self.down
    drop_table :tdbank_notifications
  end
end
