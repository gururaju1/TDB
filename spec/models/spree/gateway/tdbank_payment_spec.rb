...
module Spree
  describe Gateway::TdbankPayment do
    let(:response) do
    ...
    context "ensure tdbank validations goes fine" do
      let(:options) do
        { order_id: 17,
          email: "surf@uk.com",
          customer_id: 1,
      ...
      before do
        ...
        # we might need to stub another method in future tdbank gem versions
        ::Tdbank::API::PaymentService.any_instance.stub(make_payment_request: response)
      end
      ...
      context "3-D enrolled credit card" do
        ...
        it "raises custom exception" do
          ...
          VCR.use_cassette("3D-Secure") do
            expect {
              set_up_payment
            }.to raise_error Tdbank::Enrolled3DError
          end
        end
        ...
        it "doesn't persist new payments" do
          ...
          VCR.use_cassette("3D-Secure") do
            ...
            expect { set_up_payment }.to raise_error Tdbank::Enrolled3DError
